					...
					<div class="owl-carousel owl-theme dots-horizontal-center custom-dots-style-1 dots-dark mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 2}, '992': {'items': 3}, '1200': {'items': 4}, '1440': {'items': 5}}, 'margin': 20, 'stagePadding': 20, 'loop': true, 'nav': false, 'dots': true, 'autoplay': true, 'autoplayTimeout': 7000}">
						...
						<div class="py-5">
							<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none">
								<div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
									<div class="card-body text-center px-4 py-5">
										<img width="60" src="img/demos/law-firm-2/icons/icon-exchange.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mt-2 mb-4 pb-3'}" />
						...
						<div class="py-5">
							<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none">
								<div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
									<div class="card-body text-center px-4 py-5">
										<img width="60" src="img/demos/law-firm-2/icons/icon-magnific-dollar.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary mt-2 mb-4 pb-3'}" />
						...
						<div class="py-5">
							<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none">
								<div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
									<div class="card-body text-center px-4 py-5">
										<img width="60" src="img/demos/law-firm-2/icons/icon-car-accident.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mt-2 mb-4 pb-3'}" />
						...
						<div class="py-5">
							<a href="demo-law-firm-2-practice-areas-detail.html" class="text-decoration-none">
								<div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
									<div class="card-body text-center px-4 py-5">
										<img width="60" src="img/demos/law-firm-2/icons/icon-heart-hands.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary custom-stroke-width-1 mt-2 mb-4 pb-3'}" />
								...
								<div class="owl-carousel owl-theme custom-carousel-style-1 dots-horizontal-center custom-dots-style-1 dots-dark mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 1}, '1200': {'items': 1}}, 'loop': true, 'nav': false, 'dots': true, 'autoplay': true, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'autoplaySpeed': 500, 'dotsSpeed': 500}">
									<div data-dynamic-height="['255px','255px','255px','750px','255px']" style="height: 255px;">
										<div class="custom-carousel-style-1-icon-wrapper mb-3">
											<img width="50" src="img/demos/law-firm-2/icons/icon-court.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
										</div>
