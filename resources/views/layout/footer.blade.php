    ...
    <div class="container py-5">
        <div class="row py-4">
            ...
            <div class="col-lg-3 mb-5 mb-lg-0">
                ...
                <ul class="list list-unstyled text-3-5 mb-0">
                    <li class="mb-2"><a href="{{route('practice_area_detail')}}">Family Law</a></li>
                    <li class="mb-2"><a href="{{route('practice_area_detail')}}">Capital Law</a></li>
                    <li class="mb-2"><a href="{{route('practice_area_detail')}}">Business Law</a></li>
                    <li class="mb-2"><a href="{{route('practice_area_detail')}}">Accident & Injury Law</a></li>
                    <li class="mb-2"><a href="{{route('practice_area_detail')}}">Health Law</a></li>
                </ul>
                <a href="{{route('practice_area')}}" class="d-inline-flex custom-read-more-link justify-content-center align-items-center font-weight-medium text-color-primary svg-fill-color-primary svg-stroke-color-primary">
                    VIEW ALL
