...
<html class="side-panel">
	<head>
		...
		<title>Side Panel | Porto - Responsive HTML5 Template</title>
	...
	<body data-plugin-page-transition>
		<div class="side-panel-wrapper">
			...
			<aside class="sidebar">
				<h5 class="font-weight-semi-bold">Contact Us</h5>
				...
				<form class="contact-form" action="php/contact-form.php" method="POST">
					...
					<div class="form-row">
						<div class="form-group col">
							<label class="required text-1 mb-0">Full Name</label>
							<input type="text" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control" name="name" required>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col">
							<label class="required text-1 mb-0">Email Address</label>
							<input type="email" value="" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" required>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col">
							<label class="required text-1 mb-0">Message</label>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								...
								<h1 class="font-weight-bold text-dark">Side Panel</h1>
